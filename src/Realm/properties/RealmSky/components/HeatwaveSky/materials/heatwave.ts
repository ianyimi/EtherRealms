...
export const useHeatwaveMat = (
  ...
  // console.log(new THREE.Color(mainColor))
  const mat = useMemo(
    () =>
      new ShaderMaterial({
        uniforms: {
          color1: new Uniform(new THREE.Color(mainColor)),
          color2: new Uniform(new THREE.Color(backgroundColor)),
          color3: new Uniform(new THREE.Color(tertiaryColor)),
          speed: new Uniform(speed),
          permutations: new Uniform(permutations),
