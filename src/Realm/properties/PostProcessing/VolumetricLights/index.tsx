...
export default function VolumetricLights() {
  ...
  return (
    <group>
      <MovingSpot depthBuffer={depthBuffer} color="#0c8cbf" position={[3, 3, 2]} target={[0, 0, 3]} />
      <MovingSpot depthBuffer={depthBuffer} color="#b00c3f" position={[1, 3, 0]} target={[0, 0, 3]} />
    </group>
  )
}
